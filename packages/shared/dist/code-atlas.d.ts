...
export type RepoAppKind = "backend-api" | "fullstack-app" | "web-app" | "worker-service" | "library-heavy" | "monorepo";
...
export interface ArchitectureComponent extends ArchitectureNodeBase {
    role: "component";
    kind: "bootstrap" | "routing" | "controller" | "service" | "middleware" | "auth" | "persistence" | "utility" | "workspace_package";
    subtitle?: string;
}
...
export interface ArchitectureFlow {
    from: string;
    to: string;
    label: "HTTP" | "routes" | "uses" | "auth" | "queries" | "API calls" | "jobs" | "serves" | "handles" | "stores" | "depends on";
}
...
export interface WorkspacePackage {
    ...
    category: "web_app" | "api_app" | "shared_ui" | "api_layer" | "business_core" | "platform" | "app_store" | "embed" | "data" | "other";
    tech: string[];
    internalDeps: string[];
    evidence: EvidenceRecord[];
}
